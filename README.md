...
```
Данный скрипт выведет новый уникальный ID удаленной таблицы и предоставит вам доступ к ней. Не забудьте потом присвоить полученный ID переменной *SHEET_ID**.
