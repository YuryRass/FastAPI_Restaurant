...
class DBUpdater:
    ...
    def delete_submenu(self, submenu_id: str, menu_id: uuid.UUID) -> None:
    ...
    def delete_dish(
        self, dish_id: str, menu_id: uuid.UUID, submenu_id: uuid.UUID
    ) -> None:
    ...
    def check_submenus(
        ...
        for submenu in submenus:
            if str(submenu.id) not in submenus_id:
                ...
                submenus_id.remove(str(submenu.id))
